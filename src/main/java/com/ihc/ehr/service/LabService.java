...
public interface LabService {
	...
	List<ORMThreeColum> getLabCategory(String practiceID);
	...
	Long saveLabAttachment(ORMLabOrderAttachmentSave labAttachment,ORMLabOrderAttachmentComments labAttachmentcmnt);
