...
public interface GeneralDAO {
	...
	List<ORMDocumentPath> getDocPath(String practice_id,String doc_category);
	...
	ServiceResponse<ORMKeyValue> uploadScan(MultipartFile multipartFiormle, ScanDocumentData scanDocument);
