...
@Entity
public class ORMgetMissingClaimReport {
	 @Id
	    private String s_no;
		...
		public String getDos_display() {
			return dos_display;
		}
		public void setDos_display(String dos_display) {
			this.dos_display = dos_display;
		}
