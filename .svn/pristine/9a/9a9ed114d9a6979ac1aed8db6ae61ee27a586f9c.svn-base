...
public class ORMSavePatientRaceEthnicity {
	...
	public String toString() {
		return "ORMSavePatientRaceEthnicity [id=" + id + ", patient_id=" + patient_id + ", entry_type=" + entry_type
				+ ", cdc_code=" + cdc_code + ", cdc_description=" + cdc_description + ", omb_code=" + omb_code
				+ ", omb_description=" + omb_description + ", practice_id=" + practice_id + ", created_user="
				...
				+ ", date_modified=" + date_modified + ", system_ip=" + system_ip + "]";
	}
	public Long getId() {
		return id;
	}
