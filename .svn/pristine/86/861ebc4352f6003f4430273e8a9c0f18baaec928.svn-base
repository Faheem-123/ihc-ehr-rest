...
public interface SetupDAO {
	...
	ServiceResponse<ORMKeyValue> saveRestrictedCode(ORMRestricted_code ormSave);

	List<ORMAdjustmentReasonCodes> getAdjustcode(Long practice_id);

	ServiceResponse<ORMKeyValue> saveAdjustCode(ORMAdjustmentReasonCodes ormSave);
	...
	ServiceResponse<ORMKeyValue> saveWriteOffcode(ORMWriteOffCodes ormSave);
