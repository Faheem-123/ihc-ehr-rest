...
@Entity
@Table(name = "health_info_capture_attachment")
public class ORMHealthInformationCaptureAttachments {
	@Id
	...
	public void setHealth_info_id(String health_info_id) {
		this.health_info_id = health_info_id;
	}
