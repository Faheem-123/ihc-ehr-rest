...
public interface EncounterDAO {
	...
	// Long addUpdateTest(ORMChartOfficeTest obj);
	...
	// List<ORMThreeColumGeneric> getSexualOrientDDL();
	// List<ORMThreeColumGeneric> getGenderIdentityDDL();
	...
	ORMChartSocialHisDisplayGet ORMChartSocialHisDisplayGet(Long chart_id);
