...
@Entity
public class ORMGetSchedulerAppointmentsLocationView {
	...
	public String toString() {
		return "ORMGetSchedulerAppointmentsLocationView [appointment_id=" + appointment_id + ", appointment_date="
				...
				+ ", interpreter_req=" + interpreter_req + ", location_id=" + location_id + ", provider_id="
				+ provider_id + ", provider_name=" + provider_name + "]";
	}
