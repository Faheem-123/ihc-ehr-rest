...
public class ORMLabResultSave {
	 ...
	 @Id
	    ...
	    private String external_result_id;
	    private String external_result_id_type;
		...
		public String getExternal_result_id() {
			return external_result_id;
		}
		public void setExternal_result_id(String external_result_id) {
			this.external_result_id = external_result_id;
		}
		public String getExternal_result_id_type() {
			return external_result_id_type;
		}
		public void setExternal_result_id_type(String external_result_id_type) {
			this.external_result_id_type = external_result_id_type;
		}
		...
		public String toString() {
			return "ORMLabResultSave [result_id=" + result_id + ", patient_id=" + patient_id + ", test_id=" + test_id
					+ ", order_id=" + order_id + ", practice_id=" + practice_id + ", observation_datetime="
					+ observation_datetime + ", result_code=" + result_code + ", result_description="
					+ result_description + ", result_value=" + result_value + ", result_value_unit=" + result_value_unit
					+ ", recomended_value=" + recomended_value + ", result_status=" + result_status
					+ ", result_status_code=" + result_status_code + ", abnormal_range=" + abnormal_range
					+ ", abnormal_range_code=" + abnormal_range_code + ", physician_comments=" + physician_comments
					+ ", followup_notes=" + followup_notes + ", assigned_to=" + assigned_to + ", reviewed_by="
					+ reviewed_by + ", reviewed_date=" + reviewed_date + ", external_result_id=" + external_result_id
					+ ", external_result_id_type=" + external_result_id_type + ", deleted=" + deleted
					+ ", created_user=" + created_user + ", client_date_created=" + client_date_created
					+ ", modified_user=" + modified_user + ", client_date_modified=" + client_date_modified
					+ ", date_created=" + date_created + ", date_modified=" + date_modified + ", change_med="
					+ change_med + ", follow_up_action=" + follow_up_action + ", education_provided="
					+ education_provided + ", phy_comments_date=" + phy_comments_date + ", system_ip=" + system_ip
					+ "]";
		}
