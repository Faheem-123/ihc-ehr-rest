...
public interface MessagesDOA {
	...
	ServiceResponse saveMessage(Wrapper_MessageSave Wrapper_MessageSave);
	...
	ServiceResponse SaveCorrespondence(Wrapper_AddToCorrespondence Wrapper_AddToCorrespondence);
